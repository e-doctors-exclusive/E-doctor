        ...
        <div className='Login_Body'>
            ...
            >
                ...
                {view ? <div className="center">
                    ...
                    <h1>Patient Login</h1>
                    <input className='login_input' style={{ borderColor: "green", borderWidth: "2px" }} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Type Your Email" />
                    <input style={{ borderColor: "green", borderWidth: "2px" }} className='login_input login_password_input' onChange={(e) => setPassword(e.target.value)} type="password" placeholder="Type Your Password " />
                    ...
                    <h1>Doctor Login</h1>
                    <input style={{ borderColor: "blue", borderWidth: "2px" }} className='login_input' onChange={(e) => setDocEmail(e.target.value)} type="email" placeholder="Type Your Email" />
                    <input style={{ borderColor: "blue", borderWidth: "2px" }} className='login_input login_password_input' onChange={(e) => setDocPassword(e.target.value)} type="password" placeholder="Type Your Password " />
                    <div className='login_password_div' onClick={() => (TogglePass(), setEye(!eye))}>{
                        eye ?
                        eyeOpen : eyeClosed
                    }
