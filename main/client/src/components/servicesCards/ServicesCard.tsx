...
const ServicesCard = () => {
  return (
    ...
    <img className="image_container_service_card" alt="" src={teeth} />
      <h1 className="card-heading_service_card">Dental treatments</h1>
  ...
  <div className="box_service_card">
    <img className="image_container_service_card" alt="" src={bones} />
      <h1 className="card-heading_service_card">Bones treatments</h1>
