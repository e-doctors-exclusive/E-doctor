...
import EditeProfil from '../editeProfil/EditeProfil';
interface Doctor {
  name: string;
  lastName: string;
  Address: string;
...
const NavMenuDoctor = () => {
    ...
    return (
      <div className='profi_right_doctor'>
  ...
  <div className="details_card"><img src={avatar} alt="Image" />
              ...
              <button className="button-profile" onClick={()=>navigate('EditeProfil')}>
          ...
          <div className="comments_container">
            <div className="topnav_profil_doctor">
              ...
              <span className="navprofil_doctor" onClick={()=>navigate('Review')}>Reviews</span>
            </div>
            <Review />
          </div>
<AllReview/>
